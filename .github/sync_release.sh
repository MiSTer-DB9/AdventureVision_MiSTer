...
UPSTREAM_REPO="https://github.com/MiSTer-devel/AdventureVision_MiSTer.git"
CORE_NAME=(AdventureVision)
...
UPSTREAM_CORE_NAME=(AdventureVision)
MAIN_BRANCH="master"
UPSTREAM_BRANCH="master"
COMPILATION_INPUT=(AdventureVision.qpf)
COMPILATION_OUTPUT=(output_files/AdventureVision.rbf)
